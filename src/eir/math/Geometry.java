...
public class Geometry
{
	 ...
	 * @return
	 */
/*	public static double calcDistanceToLine(final Vector2 P, final Vector2 Q, final Vector2 v)
	{
	 ...
	 */
/*	public static Vector2 calcIntersection(final Vector2 P, final Vector2 u, final Vector2 Q, final Vector2 v)
	{
		Vector2 w = P.minus(Q);
