...
public class ShaderLoader extends AsynchronousAssetLoader <ShaderProgram, ShaderParameters>
{
	...
	{
		FileHandle vertexShaderFile = Gdx.files.internal( parameter.getVertexShaderFile() );
		if(!vertexShaderFile.exists())
			throw new IllegalStateException("cannot find default shader");
		vertexShader = vertexShaderFile.readString();
		FileHandle maskingShaderFile = Gdx.files.internal( parameter.getFragShaderFile() );
	...
	@Override
	public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file, ShaderParameters parameter) { return null; }
